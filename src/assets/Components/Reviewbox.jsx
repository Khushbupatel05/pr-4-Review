    ...
    <>
        <div className='container mx-auto'>
            ...
            <div className="flex items-start mb-5 mt-5">
                ...
                <input id="terms" type="checkbox" defaultValue className="w-4 h-4 border border-gray-300 rounded-sm bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 " required />
                </div>
